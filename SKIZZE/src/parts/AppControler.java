...
/**
 * 
 * Ein Controler, der aus verschiedenen Teilen {@link AppPart} besteht und auf
 * Änderungendas des Model {@link Skizze} hört
 * 
 * @author Thomas Nill
 *
 */
...
public class AppControler implements SkizzenListener {
    ...
    private List<AppPart> parts = new ArrayList<AppPart>();

    private List<SkizzenListener> l = new ArrayList<SkizzenListener>();
