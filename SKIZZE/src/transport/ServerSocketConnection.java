...
public class ServerSocketConnection extends SocketConnection implements
        SocketListener {
    ...
    public void write(List<Object> objects, SocketConnection client) {
    ...
    private void readObjects(ClientSocketConnection client)
